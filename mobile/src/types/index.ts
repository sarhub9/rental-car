...
export type RootStackParamList = {
  ...
  AgreementCreate: undefined;
  AgreementEdit: { agreementId: string };
  AgreementView: { agreementId: string };
  Checkout: { agreementId: string };
  Return: { agreementId: string };
};

export type OwnerAdminStackParamList = {
  ...
  AuditLog: undefined;
  Settings: undefined;
  AdminAgreementList: undefined;
  AdminAgreementView: { agreementId: string };
  AdminInvoiceList: undefined;
  AdminInvoiceDetail: { invoiceId: string };
  AdminVehicleList: undefined;
  FleetVehicleCreate: undefined;
  FleetVehicleDetail: { vehicleId: string };
  FleetVehicleEdit: { vehicleId: string };
...
export type CustomerStackParamList = {
  ...
  CreateDispute: { agreementId: string; chargeId?: string };
...
export type DriverRecoveryStackParamList = {
...
export type AccountsStackParamList = {
  ...
  AccountsInvoiceList: undefined;
  AccountsInvoiceDetail: { invoiceId: string };
  AccountsPaymentList: undefined;
  AccountsReports: undefined;
  DepositList: undefined;
  TollFineList: undefined;
};

// ============================================================================
// ERP Upgrade Types (006)
// ============================================================================
