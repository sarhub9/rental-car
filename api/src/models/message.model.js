...
class MessageModel {
  ...
  async createThread(data) {
    const { tenant_id, customer_id, subject } = data;
    const result = await pool.query(
      `INSERT INTO message_threads (tenant_id, customer_id, subject, status)
       VALUES ($1, $2, $3, 'OPEN')
       RETURNING *`,
      [tenant_id, customer_id, subject],
    );
   ...
   */
  async listCustomerThreads(customerId, tenantId, filters = {}) {
